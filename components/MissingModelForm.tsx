...
export function MissingModelForm() {
  ...
  return (
    ...
    >
      ...
      <label>Product Type<select name="productType"><option>Headlights</option><option>Tail Lights</option><option>Exhaust Systems</option><option>Forged Wheels</option><option>Body Kits</option><option>Other Automotive Parts</option></select></label>
